...
WHERE usuario.id_usuario='$id_usuario' AND solicitud_visita.semestre = '$semestre' AND solicitud_visita.grupo = '$grupo' AND solicitud_visita.id_carrera = '$id_carrera' AND solicitud_visita.asignatura = '$asignatura'";
